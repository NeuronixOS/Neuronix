...
Any key, click, or mouse move exits.
...
class SaverWindow(Gtk.Window):
    def __init__(self, app: "ScreensaverApp", monitor: Gdk.Monitor, mode: str):
        ...
        self._armed = False  # ignore input until delay elapses / first paint
        ...
        # Input: any significant pointer move / click / key quits
